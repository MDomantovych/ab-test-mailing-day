...
* **Стійкість:** z-тест, OLS з кластерними SE по користувачу, кластерний бутстреп, поправка на канал/воркфлоу/тиждень,
  ...
  і двосторонні FE з поправкою на попередній дотик і номер повідомлення (+1.39 п.п., найконсервативніша оцінка) — вісім оцінок
  у діапазоні +1.4…+1.8 п.п. Порівняння всередині користувача прибирає між-користувацьку дисперсію, тобто виконує роль CUPED
  без окремого передперіоду.
...
├── tests/test_abtools.py            <- 15 тестів: чисті функції на відомих значеннях, синтетичні панелі, інтеграційний тест на реальному лозі
